...
function Modal({clickClose,newTache,setNewTache,newdesc,setNewDesc,handleAddTache,messaageErr}) {
    return (
        // Modal Wrapper
        <>
                            ...
                            <form className="flex-col sm:flex-col space-y-6 md:px-11">
                                <div className="flex flex-col gap-7">
                                    <div className="">
                                        ...
                                        <div className="mt-2">
                                            <input id="tache" type="text" value={newTache} onChange={(e) => setNewTache(e.target.value)} required className="block w-full rounded-md border-0 px-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm md:text-xl sm:leading-6" />
                                        </div>
                                    </div>
                                    <div className="">
                                        ...
                                        <div className="mt-2">
                                            <input id="description" type="text" value={newdesc} onChange={(e) => setNewDesc(e.target.value)} required className="block w-full rounded-md  px-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm md:text-xl sm:leading-6" />
                                        </div>
                                    </div>
